...
from https://ssb22.user.srcf.net/papers/cvu.html (also [mirrored on GitLab Pages](https://ssb22.gitlab.io/papers/cvu.html) just in case)
...
* Nine-carat Gold Open Access?: C Vu, 38(1):11-12, March 2026. (journal websites can be taken offline)
* A Look at Svelte: C Vu, 38(1):6-7, March 2026.
* Scraping the Bins with Rubbish Code: C Vu, 38(1):5-6, March 2026. (Alexa skill to scrape municipal waste collection schedules)
...
* Book review: Asynchronous Programming in Rust by Carl Fredrik Samson: C Vu, 37(4):20, September 2025.
* What M3GAN can tell us about software engineering: C Vu, 37(4):5-7, September 2025.
* Long-running actions on GitHub: C Vu, 37(3):6-7, July 2025.
* Beginners’ Python on Amazon Alexa: C Vu, 37(3):3-4, July 2025. (Here’s [the code plus a couple of enhancements on GitHub](https://github.com/ssb22/bits-and-bobs/commits/master/helper.py))
* The Full-Time Fallacy: C Vu, 36(6):4-5, January 2025.
* Eleven C++11 Features Worth Knowing About: C Vu, 36(5):6-7, November 2024.
* Blaming Organisational Incompetence on Inclusivity?: C Vu, 36(4):7-9, September 2024. (Crowdstrike, care in coding, Twitter/X toxicity & unintended consequences of engagement optimisation)
* Adding Python Scripts to PyPI.: C Vu, 36(3):8, July 2024.
* Long Lines of Python.: C Vu, 36(3):3, July 2024.
...
* When Will Python 2 End: An Update.: C Vu, 32(3):9, July 2020. (Python 2 was in Ubuntu 20.04—later also 22.04—with extended support, but unclear how long Pip’s servers will support pip 20)
...
* GitHub’s Crazy Contribution-Graph Game.: C Vu, 31(1):8-11, March 2019. (How I ended up playing it as a favour, with unintended consequences like delaying commits to other days; see [useless metrics](https://ssb22.user.srcf.net/metrics.html) for streak data)
...
* Thonny: Python IDE for Beginners (review).: C Vu, 29(4):5, September 2017. (Update: beware Thonny 4 contains a pro-Ukraine message which might get you in trouble in some countries; [Thonny 3](https://web.archive.org/web/20220220173712/https://thonny.org/) is not affected)
...
* Book review: Reader’s Digest How to do just about anything on the Internet.: C Vu, 15(3):34, June 2003. (A bad book)
