...
Straight CFLs of height 115mm (including base and electronics; half-tube height 55mm) are only 11W and rated between 600 and 650 lumens. These ratings are supposed to account for the 40% loss due to tube occlusion, but they tend not to account for the 20% drop in brightness that occurs during the bulb’s lifetime (mostly toward the beginning), so we could be looking at anything between 290 and 520 lumens when the bulb is not brand-new. By comparison, an old 60W (halogen 43W), to which the 11W CFL is supposed to be equivalent, should be between 700 and 800 lumens (depending whom you ask) whereas an old 40W is about 450 lumens.
