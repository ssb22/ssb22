...
* I was not able to see or detect flicker from a Morrison-branded A60-size 1521-lumen B22 11W 2700K “100W equivalent” bought in Dorset in 2022; in 2026 this exhibited a failure mode where it started flashing 5 to 7 times a second (sometimes alleviated by switching off and on) probably due to a failing capacitor, so we replaced it with a 13.8W 1521lm S.I.Ltd “Eveready” S13626 bought from an independent shop and I was not able to see or detect flicker from this.
...
* And we found no flicker on some “Diall” bulbs from B&Q installed in a house: they were LP-A65-1S (9W 806lm, B22 and E27) and LP-A60-11S (6W B22). We also found no flicker on Diall’s E27 “reflector” (R63) bulbs bought in 2022 (470lm and 600lm “warm white”)—keep the receipt as ours had a 22% early-failure rate—or their E27 clear GLS 806lm, but we *did* find flicker on a Diall 78mm R7S (for a patio light) and on Diall integrated downlights (see below), so *some* Diall models can flicker. Diall’s old 35mA 4W 3000K 224lm 100-degree GU10 LEDs flickered but in 2026 we replaced one with a Diall 20mA 2.4W 2700K 230lm 90-degree (rated 36 degrees to 50%) with no noticeable or camera-detected flicker. (We also detected no flicker on their display of a Philips Smart LED Dimmable Warm White GU10 or the Philips clear filament bulbs but the non-filament Philips Hue was still flickering.)
* An unbranded 12W replacement R7S in 2025 did not flicker but lacked enough information for us to know where the private seller had obtained it.
...
* We found no noticeable or camera-detected flicker from a Novostella 24W 2650-lumen “Tunable White LED Ceiling Light” (a larger circular flush fixture with infrared remote control—its codes can be input into third-party infrared devices like Tuya’s, although Tuya’s Alexa interface is on/off only when used via infrared). We did find 1 out of 4 units started intermittently cutting out 4 years after installation—its connector allowed user-swapping with an identical unit, but they’d been discontinued and Novostella said their newer products won’t fit, so the best we could do without further electrical work was to swap the faulty one into a lesser-used room.
...
* A JCC V50 Pro Retrofit integrated downlight installed in 2026 (to reduce fire risk in the previous holder) did flicker: the modulation depth wasn’t the worst I’ve seen but it was there (JCC technical support are still looking into it: they said their photometric engineer will re-test in a goniophotometer, presumably with a high-speed photodiode, but I’ve not heard back since and meanwhile we’re not using this light much).
...
### Other LED
* In 2026 we had some LED tapes installed in a shed with a JCC BC020013 75W 24V and found no noticeable or camera-detected flicker although the strips without diffusers can glare. The broken installation it replaced had used a HT1206000B which did flicker.
