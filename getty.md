...
from https://ssb22.user.srcf.net/poem/getty.html (also [mirrored on GitLab Pages](https://ssb22.gitlab.io/poem/getty.html) just in case)

# Getty Images copied my words

Getty Images have a reputation for suing anyone who copies their images without permission (which requires payment, and their prices can be high), so I am disappointed to report that in 2018 they copied my *words* without so much as an acknowledgement or link, and they did not seem able to handle my attempts to report that to them. I received no reply and the words stayed on their site without acknowledgement until 2025 when that page was removed.

My main concern was actually that the words they copied could be misleading when used out of context in this way, which is why I changed the original (but wasn’t able to get Getty to change their copy).

Here are the words that Getty Images copy-pasted verbatim from an earlier version of my [Xu Zhimo page](https://ssb22.user.srcf.net/poem/) into one of their photograph descriptions:
...
J. Paul Getty is said to have changed Matthew 5:5 into “the meek shall inherit the earth but not the mineral rights”. His company now seems to want to add “copyright” to that—whenever I see a Getty Images credit in a magazine or video, I can’t help thinking “them again—wanting fair credit from us, but applying a different set of rules to themselves”. Their acting like this is damaging their image, and might even make judges less sympathetic to them when they take others to court—if you are in the business of suing other people for copyright infringement, then it stands to reason that you should “go the extra mile” to avoid doing it yourself. Yes it may be only one paragraph from a random person’s home page, and I may not be inclined to go out looking for lawyers, but if some lawyer found *me* and said their client is being sued by Getty Images and would I be so kind as to sign a copyright transfer so they can countersue, I can’t honestly say I wouldn’t have considered it. So copying individuals’ paragraphs without credit (and without an obvious complaints-handling procedure) could be a legal bad move for Getty Images as well as making them look bad.

I don’t know if that’s why the page was taken down in 2025 or if it was going anyway. There was nothing wrong with the *image*; it simply needed the description to be edited.
