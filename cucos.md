...
from https://ssb22.user.srcf.net/old-ccs/cucos.html (also [mirrored on GitLab Pages](https://ssb22.gitlab.io/old-ccs/cucos.html) just in case)
...
* The track listing is as follows:
  1. Pastoral Song 牧歌 (5:08)
  2. A Gust of Wind 刮地風 (2:39)
  3. Embroidery Shoes 繡花鞋 (2:51)
  4. Tune of Anhui 安徽小調 (4:14)
  5. Counting Flowers 數花 (2:17)
  6. He Nina 赫尼那 (3:30)
  7. Pick the Reed Catkins 撥根蘆柴花 (2:47)
  8. Leading Livestock 趕牲靈 (3:46)
  9. Tune of Henan 豫調 (3:06)
  10. Dao Laji 道拉基 (2:42)
  11. Weaving Cloth For The Dearest One 織花織布送哥穿 (3:10)
  12. Green High Mountain 高山青 (3:04)
  13. Tea-Picking Song 采茶歌 (2:02)
  14. Green Pomegranate 石榴青 (1:54)

I wrote down the tunes from tracks 12, 8 and 2 (高山青, 趕牲靈 and 刮地風) and made a flute duet so I could perform with a [CUCCS](ccs.md) committee member in their 2007 concert (which was before CCS decided to turn their concert into a pop singing contest).
...
![cid2017.jpg](https://ssb22.user.srcf.net/old-ccs/cid2017.jpg)
...
* in 2010 CID invited some WID players to join in for a piece called *Golden Age* (with lots of fun time-signature changes);
...
As far as flute parts go, the non-joint arrangements that CUCOS WID obtained from Chinese publishers do tend to have the minor annoyances of treating us as extra piccolos (I had to find [fingerings above top C](fingering.md#high)), rarely using the nicer-sounding lower register (perhaps because this isn’t available on the Chinese *dízi* flute), and sometimes being printed a bit sloppily and with dozens of ledger lines (usually fused together) when any ‘sensible’ arranger should have used ottavation (8va). If I can’t quickly [sort it out with The GIMP](https://ssb22.user.srcf.net/notes/#gimp) then I tend to re-do my part in Lilypond—usually by hammering out the notes in [mwr2ly](https://ssb22.user.srcf.net/mwrhome/) and editing the result, catching any copying mistakes in rehearsal.

*The view from my desk at the 2016 West Road rehearsal*

![wid2016.jpg](https://ssb22.user.srcf.net/old-ccs/wid2016.jpg)
...
* If a local student has rearranged a piece, they might have a file that can be printed with larger staves and octave adjustments without having to re-input everything from scratch. Before the lockdown, some used Sibelius—there was a copy of it on the UIS Teaching Room PCs (I’d suggested Sibelius’s “Scorch” viewer and that apparently prompted them to check with the music department and license the whole thing) but these PCs were removed in 2022; since then they’ve sometimes used MuseScore, which can export MusicXML that can be imported to Lilypond via `musicxml2ly --nb --nd --nrp --npl --nsd -z file.mxl` and light edits (Lilypond makes better use of space in big print, minimising page turns).

Why PhotoScore didn’t help:

In 2018 the UIS upgraded to Sibelius 8 Ultimate which included “PhotoScore & NotateMe Lite 8” scanning software, but this extra feature did not help. Although it was good at reading pitches, basic durations and tuplets from a scanned part (at least when saved as JPEG with 100% quality: it said “TIFF didn’t Open” to PDF and “PhotoScore cannot open compressed .bmp files” to *non*-compressed BMP), it ignored phrase marks, staccato dots, dynamics, text directions and multibar rests, and during my test it faulted on excessively-steep beams, mistook a small tie for a dot (throwing off the tuplet parsing for a bar) and mistook naturals for flats during a modulation into C Major. If you’re reasonably good at typing in music from scratch then you will likely find the task of fixing PhotoScore’s read—especially after it’s been through `musicxml2ly`—to be more troublesome than that of simply entering the music yourself.

CID usually uses Jianpu notation—they tend to handwrite it but have occasionally used XunScore, Ziipoo, Xihang’s Music Notation app, or my [Jianpu in Lilypond](https://ssb22.user.srcf.net/mwrhome/jianpu-ly.html) script.

Some of the music CUCOS has played has been political etc, and I try to avoid participating in those pieces, but it’s not always obvious and I have occasionally been caught out by playing something that I didn’t realise had such connections until receiving programme notes *after* the concert. It’s better to remember to ‘look up’ each piece yourself. (I’ve also been known to drop out if they give the whole concert a title that feels uncomfortable—thankfully this isn’t every time.)

*Part of the 2023 joint orchestra with graduate composer [Jingyu Chen](https://www.jingyuchen.com/)*

![j2023.jpg](https://ssb22.user.srcf.net/old-ccs/j2023.jpg)
...
In 2012 a Chinese student on a summer English language programme had brought her large guzheng, and she had too much luggage to take back so she wanted to sell the guzheng and buy another back in China. We arranged to buy it for the club, and I stored it in my flat until they returned to Cambridge in the autumn. Before selling it to us, the student had tried a city centre music shop that displayed a sign saying “if it’s musical, it’s here!” They didn’t want it. I do like that music shop (they once lent me a piccolo for a concert at the 11<sup>th</sup> hour), but I had to resist the temptation to walk in and say “how about a Chinese guzheng—it’s musical, why isn’t it here?” They removed that sign shortly afterwards.
